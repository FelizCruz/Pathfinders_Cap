...
This demo demonstrates the integration of Kalshi prediction market data with news data from News API, and uses Azure OpenAI for semantic analysis to understand correlations between market predictions and news sentiment.
...
- News API key (get free key at https://newsapi.org/)
